                        ...
                        <div class="modal fade" id="koko{{ $itemm->no_kk }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    @php
                                        $status11 = $itemm->warga_sukarela->where('jenis_iuran_id', 1);
                                        $status22 = $itemm->warga_sukarela->where('jenis_iuran_id', 2);
                                    @endphp
                                    <div class="modal-body">
                                        ...
                                        @if (count($status11) == 0)
                                            <a href="{{ route('user.kas-rt.kas-iuransukarela.index') }}">input
                                                pembayaran</a>
                                        @endif
                                        </p>
