            ...
            <div class="col-md-11">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br />
                        <br />
                        <form action="{{ route('user.kepala-keluarga.bayar-iuranagenda.store') }}" id="form"
                        ...
                        <div class="modal fade" id="koko{{ $itemm->no_kk }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    @php
                                        $status11 = $itemm->warga_agenda->where('jenis_iuran_id', 1);
                                        $status22 = $itemm->warga_agenda->where('jenis_iuran_id', 2);
                                    @endphp
                                    <div class="modal-body">
                                        <h5>Halal Bi Halal</h5>
                                        ...
                                        @if (count($status11) == 0)
                                            <a href="{{ route('user.kas-rt.kas-iuranagenda.index') }}">input pembayaran</a>
                                        @endif
                                        <h5>Pringantan HUT RI</h5>
                                        </p>
                                        @foreach ($status22 as $i)
                                            <p>{{ date('d M Y', strtotime($i->tanggal)) }}
                                        @endforeach
                                        <label for=""
